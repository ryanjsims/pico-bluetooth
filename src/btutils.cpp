...
const char* bt_strattribute(uint16_t bluetooth_attribute) {
    switch(bluetooth_attribute) {
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PUBLIC_BROWSE_ROOT);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_FEATURES);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_CAPABILITIES);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_FUNCTIONS);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_TOTAL_IMAGING_DATA_CAPACITY);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DOCUMENT_FORMATS_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_CHARACTER_REPERTOIRES_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_XHTML_PRINT_IMAGE_FORMATS_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_COLOR_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_1284_ID);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PRINTER_NAME);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PRINTER_LOCATION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DUPLEX_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MEDIA_TYPES_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MAX_MEDIA_WIDTH);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MAX_MEDIA_LENGTH);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_ENHANCED_LAYOUT_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_RUI_FORMATS_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_REFERENCE_PRINTING_RUI_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DIRECT_PRINTING_RUI_SUPPORTED);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_REFERENCE_PRINTING_TOP_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DIRECT_PRINTING_TOP_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PRINTER_ADMIN_RUI_TOP_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DEVICE_NAME);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_RECORD_HANDLE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_CLASS_ID_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_RECORD_STATE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_ID);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PROTOCOL_DESCRIPTOR_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_BROWSE_GROUP_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_LANGUAGE_BASE_ATTRIBUTE_ID_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_INFO_TIME_TO_LIVE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_AVAILABILITY);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_BLUETOOTH_PROFILE_DESCRIPTOR_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DOCUMENTATION_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_CLIENT_EXECUTABLE_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_ICON_URL);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_ADDITIONAL_PROTOCOL_DESCRIPTOR_LISTS);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_VENDOR_ID);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PRODUCT_ID);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_VERSION);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PRIMARY_RECORD);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_VENDOR_ID_SOURCE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_DATA_EXCHANGE_SPECIFICATION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MCAP_SUPPORTED_PROCEDURES);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_DEVICE_RELEASE_NUMBER);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_PARSER_VERSION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_DEVICE_SUBCLASS);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_COUNTRY_CODE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_VIRTUAL_CABLE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_RECONNECT_INITIATE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_DESCRIPTOR_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HIDLANGID_BASE_LIST);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HIDSDP_DISABLE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_BATTERY_POWER);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_REMOTE_WAKE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_PROFILE_VERSION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_SUPERVISION_TIMEOUT);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_NORMALLY_CONNECTABLE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HID_BOOT_DEVICE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HIDSSR_HOST_MAX_LATENCY);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_HIDSSR_HOST_MIN_TIMEOUT);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MAS_INSTANCE_ID);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_MESSAGE_TYPES);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MAP_SUPPORTED_FEATURES);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SERVICE_VERSION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_FORMATS_LIST);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_IP_SUBNET);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SECURITY_DESCRIPTION);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_NET_ACCESS_TYPE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MAX_NET_ACCESSRATE);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_IPV4_SUBNET);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_IPV6_SUBNET);
        __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_REPOSITORIES);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_PBAP_SUPPORTED_FEATURES);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_DATA_STORES_LIST);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MPSD_SCENARIOS);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_MPMD_SCENARIOS);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_SUPPORTED_PROFILES_AND_PROTOCOLS);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_CAS_INSTANCE_ID);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_CTN_SUPPORTED_FEATURES);
        // __ENUMERATE_CODE(BLUETOOTH_ATTRIBUTE_GNSS_SUPPORTED_FEATURES);
        default:
            return "BLUETOOTH_ATTRIBUTE_UNKNOWN";
    }
}
